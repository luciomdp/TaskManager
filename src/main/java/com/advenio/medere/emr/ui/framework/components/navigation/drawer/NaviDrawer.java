...
implements AfterNavigationObserver {
	...
	private static final long serialVersionUID = -5166159999461331995L;
	...
	private void initHeader() {
		mainContent.add(new BrandExpression(appController.getApptitle()));
	}
	...
	private void initSearch() {
		...
		search.setPlaceholder(getTranslation("Search",null));
	...
	private void initFooter() {
		railButton = UIUtils.createSmallButton(getTranslation("Collapse", null), VaadinIcon.CHEVRON_LEFT_SMALL);
	...
	private void toggleRailMode() {
		if (getElement().hasAttribute(RAIL)) {
			...
			railButton.setText(getTranslation("Collapse", null));
			...
			railButton.setText(getTranslation("Expand", null));
